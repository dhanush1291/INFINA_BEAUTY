...
export const Route = createFileRoute("/policies/terms")({
  component: TermsPage,
  head: () => ({ meta: [{ title: "Terms of Service — Sai" }] }),
});
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-16 lg:px-8">
      ...
      <div className="mt-6 space-y-4 text-muted-foreground">
        <p>By using Sai, you agree to these terms. Sai is a curation and affiliate platform; products are sold by partner retailers.</p>
        <h2 className="mt-6 font-serif text-2xl text-foreground">Affiliate disclosure</h2>
        <p>Sai may earn a commission on purchases completed through partner links. This does not affect the price you pay.</p>
        ...
        <p>Sai is not responsible for transactions, shipping, returns, or product quality — these are the responsibility of the partner retailer.</p>
      </div>
    </div>
  );
}
